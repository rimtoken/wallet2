...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'connectWallet': 'ربط المحفظة',
    'connectYourWeb3Wallet': 'قم بربط محفظة Web3 الخاصة بك للتفاعل مع البلوكتشين',
    'selectWallet': 'اختر المحفظة',
    'selectWalletDescription': 'اختر من محافظ Web3 المدعومة لإكمال الاتصال',
    'popularWallets': 'المحافظ الشائعة',
    'allWallets': 'جميع المحافظ',
    'connectingToWallet': 'جاري الاتصال بالمحفظة',
    ...
    'yourWalletIsNowConnected': 'محفظتك متصلة الآن ويمكنك التفاعل مع التطبيق',
    'walletConnectionFailed': 'فشل الاتصال بالمحفظة',
    'failedToConnectWallet': 'تعذر الاتصال بالمحفظة. يرجى المحاولة مرة أخرى',
    'addressCopied': 'تم نسخ العنوان',
    'walletAddressCopiedToClipboard': 'تم نسخ عنوان محفظتك إلى الحافظة',
    'walletDisconnected': 'تم فصل المحفظة',
    'walletDisconnectedSuccessfully': 'تم فصل محفظتك بنجاح',
    'connectedWallets': 'المحافظ المتصلة',
    'manageYourConnectedWallets': 'إدارة محافظ Web3 المتصلة الخاصة بك',
    'explore': 'استكشاف',
    'disconnect': 'فصل',
    'walletsConnected': 'محافظ متصلة',
  },
  en: {
