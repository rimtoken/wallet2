    ...
    <div className="container mx-auto py-12 px-4">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          نحن فريق من الخبراء المتحمسين للتكنولوجيا المالية والعملات الرقمية، 
          نعمل معًا لتقديم أفضل تجربة ممكنة لمستخدمي RimToken
        </p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {teamMembers.map((member) => (
          <div key={member.id} className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="mt-16 text-center">
        <h2 className="text-2xl font-bold mb-6">انضم إلى فريقنا</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
          نحن دائمًا نبحث عن مواهب جديدة للانضمام إلى فريقنا المتنامي.
          إذا كنت متحمسًا للتكنولوجيا المالية والعملات الرقمية، فنحن نرحب بك!
        </p>
        <a href="#" className="inline-block bg-amber-500 hover:bg-amber-600 text-white font-bold py-3 px-6 rounded-lg transition-colors">
